...
const FIRE_ARCHER: Dictionary = {
	...
	"description": "На Огненной земле обучают молодых лучников обращению с магией пламени. С её помощью они поджигают врагов и заставляют погибать их мучительной смертью."
}
