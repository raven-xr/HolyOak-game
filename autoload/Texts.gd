...
var tutorial_first_towers_1 = {
	'text': 'Для начала построим башню. Нажмите на пустое поле справа',
	'position': Vector2(752.0, 184.0),
	'target_signal': 'tree_exited'
}

var tutorial = {
	'greeting': [tutorial_greeting_1, tutorial_greeting_2],
	'first_towers': [tutorial_first_towers_1]
}
